...
[uninstalled] [4.1.5 ] wrapper           standard-4.1.5      Provide OS integration
[uninstalled] [4.1.5 ] obr               standard-4.1.5      Provide OSGi Bundle Repository (OBR) support
[uninstalled] [4.1.5 ] config            standard-4.1.5      Provide OSGi ConfigAdmin support
[uninstalled] [4.1.5 ] region            standard-4.1.5      Provide Region commands
[uninstalled] [7.5.4.v20111024] jetty             standard-4.1.5      Provide Jetty engine support
[uninstalled] [4.1.5 ] http              standard-4.1.5      Implementation of the OSGI HTTP Service
[uninstalled] [4.1.5 ] http-whiteboard   standard-4.1.5      Provide HTTP Whiteboard pattern support
[uninstalled] [4.1.5 ] war               standard-4.1.5      Turn Karaf as a full WebContainer
[uninstalled] [4.1.5 ] deployers         standard-4.1.5      Provide Karaf deployer
[uninstalled] [4.1.5 ] kar               standard-4.1.5      Provide KAR (KARaf archive) support
[uninstalled] [4.1.5 ] webconsole-base   standard-4.1.5      Base support of the Karaf WebConsole
[uninstalled] [4.1.5 ] webconsole        standard-4.1.5      Karaf WebConsole for administration and monitoring
[uninstalled] [4.1.5 ] ssh               standard-4.1.5      Provide a SSHd server on Karaf
...
Maven builds the web application, web-4.1.5.war, and
